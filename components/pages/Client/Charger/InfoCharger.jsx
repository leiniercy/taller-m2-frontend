                ...
                <div className="bg-gray-items card grid h-full sm:h-full md:h-30rem">
                    ...
                    <div className="col-12 sm:col-12 md:col-6 md:flex md:justify-content-center md:align-items-center">
                        <div className="card grid">
                            ...
                            <div className="col-5">
                                <span
                                    className="block text-base sm:text-base lg:text-lg xl:text-2xl mb-2"> {charger.connectorType}</span>
                                <span
                                    className="block text-base sm:text-base lg:text-lg xl:text-2xl mb-2"> {charger.compatibleDevice}</span>
                            </div>
                        </div>
                    </div>
                </div>
