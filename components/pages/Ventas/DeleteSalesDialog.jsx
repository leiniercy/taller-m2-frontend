...
const DeleteSalesDialog = (props) => {
    ...
    ); /*Footer del dialog de eliminacion de varias ventas*/
    ...
    return (<Dialog visible={props.visible} style={{width: '32rem'}}
        ...
        <div className="confirmation-content">
            ...
            {props.object && <span>"¿Esta seguro que desea eliminar las ventas seleccionadas?</span>}
        </div>
    </Dialog>);
}

DeleteSalesDialog.propTypes = {
